...
// CYJCODE: Enable all experimental features by default
...
const defines = {
  ...
  'MACRO.ISSUES_EXPLAINER': JSON.stringify(
    'Report issues at https://github.com/chenyangji/cyjcode/issues',
  ),
  'MACRO.VERSION_CHANGELOG': JSON.stringify(
    dev ? getVersionChangelog() : 'https://github.com/chenyangji/cyjcode',
  ),
} as const
