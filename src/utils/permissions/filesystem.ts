...
// Always ask when NTCode tries to edit its own config files
 ...
 * This is a per-user temporary directory used by NTCode for all temp files.
 *
 ...
 * - MCP CLI state files (managed internally by NTCode)
