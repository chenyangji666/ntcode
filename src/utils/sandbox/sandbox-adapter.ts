...
/**
 * Resolve NTCode-specific path patterns for sandbox-runtime.
 *
 * NTCode uses special path prefixes in permission rules:
...
/**
 * Convert NTCode settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where NTCode started)
