...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when NTCode was first started on this machine
  ...
  // NTCode usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first NTCode OAuth token
  ...
  // NTCode hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).
