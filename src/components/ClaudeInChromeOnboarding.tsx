...
export function ClaudeInChromeOnboarding(t0) {
  ...
  let t5;
  if ($[6] !== t4) {
    t5 = <Text>NTCode in Chrome works with the Chrome extension to let you control your browser directly from NTCode. You can navigate websites, fill forms, capture screenshots, record GIFs, and debug with console logs and network requests.{t4}</Text>;
    $[6] = t4;
    $[7] = t5;
  } else {
    t5 = $[7];
  ...
  let t11;
  if ($[17] !== onDone || $[18] !== t10) {
    t11 = <Dialog title="NTCode in Chrome (Beta)" onCancel={onDone} color="chromeYellow">{t10}</Dialog>;
    $[17] = onDone;
    $[18] = t10;
    $[19] = t11;
  } else {
